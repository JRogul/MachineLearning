...
def return_dataloaders(train_batch_size, val_batch_size, test_batch_size):
    ...
    train_dataset = datasets.MNIST(root="C:\\Users\\giga\\Desktop\\gitt\\MachineLearning\\auteencoders\\data",
                                   train=True, download=False, transform=train_transforms)
    val_dataset = datasets.MNIST(root='C:\\Users\\giga\\Desktop\\gitt\\MachineLearning\\auteencoders\\data',
